...
def find_in_order_successor(root,target):
    ...
    while done !=True:
        ...
        if target < current_node.value:
            if current_node.left != None:
                ...
                print(f"Found successor: {current_node.value}")
...
def is_valid_bst(root):
    '''
    1. Do in-order traversal. The in-order traversal always start from the left mode node and keeps walking to the right most. This way, the left mode node is the smallest
    Algo:
    ...
    while done != True:
        ...
        if cur_node != None:
            ...
            if len(stack) != 0:
                cur_node=stack.pop()
                if rightmost_found == True:
                    if cur_node.value > priv_node:
                        print("valid")
                    else:
                        print("invalid")
                priv_node = cur_node.value
                print(priv_node)
...
#find_in_order_successor(root,5)
is_valid_bst(root)